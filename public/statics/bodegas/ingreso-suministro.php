...
<body onload="relojCalendario()">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 espacio">
                <form name="form" class="form" id="form" method="POST" action="">
                    <!-------------------------HTML------------------------------->
                    <!------------------------------------------------------------->
                    <?php include_once 'ingreso-suministro.html'?>
                </form>
            </div>
            <div class="col-xs-0 col-sm-0 col-md-1 col-lg-1 espacio">
                <!---------------------------ORILLA DERECHA------------------------------->
    ...
    <script src="../js/bodegas/ingreso-suministro.js"></script>
     <!--JS<script type="text/javascript" src="../js/contabilidad/ingresoBodega.js"></script>-->
    <!-------------------------JS------------------------------->
    <!---------------------------------------------------------->
