...
<head>
    ...
    <title>División | CanteraSoft</title>
...
<body>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 espacio">
                <form name="form" class="form" id="form" method="POST" action="">
                    <?php include_once '../funciones/rrhh/division/seleccionar.php';?>
                    <?php include_once 'division.html';?>
                </form>
            </div>
            <div class="col-xs-0 col-sm-0 col-md-1 col-lg-1 espacio">
            </div>
    ...
    <script type="text/javascript" src="../js/rrhh/division.js"></script>
