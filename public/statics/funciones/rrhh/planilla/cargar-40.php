...
<div class="container-fluid">
    <div class="row" >
        <h3>Sueldo 40%</h3>
		<table class="display nowrap table-bordered table-hover" style="width:100%"  id="tablaPlanilla40">
			<thead>
				<tr id='titulo' class='table-active'>
					<td id="M0">No. Cuenta</td>
					<td id="M1">Empleado</td>
					<td id="M2">Sueldo 40%</td>
			...
			<?php 
                ...
                $sql= "SELECT cuentaBancaria, nombreEmpleado, apellidoEmpleado, anticipoSueldo, nombreDepartamento, fechaPlanilla, horaPlanilla FROM empleado
                            INNER JOIN planilla
