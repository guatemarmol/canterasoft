...
<?php
$codigo   = $_POST['codigo'];
$consulta = "SELECT * FROM estadoJumbo WHERE codigo='$codigo'";
...
if ($fila > 0) {
    ...
    $fecha       = $_POST['fecha'];
    $hora        = $_POST['hora'];
    $actualizar  = "UPDATE estadoJumbo SET descripcion='$descripcion', fecha='$fecha', hora='$hora' WHERE codigo='$codigo'";
    ...
    $consulta = "SELECT MAX(codigo) codigo FROM estadoJumbo";
    $ejecutar = mysqli_query($con, $consulta);
    ...
    $fecha       = $_POST['fecha'];
    $hora        = $_POST['hora'];
    $agregar     = "INSERT INTO estadoJumbo (codigo, descripcion, fecha, hora)
