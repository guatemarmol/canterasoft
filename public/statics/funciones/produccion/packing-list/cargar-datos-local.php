...
<div class="container-fluid" id="datosPL">
    <div class="row" style="padding: 5px 65px 40px 65px;">
        <table class="display nowrap table-bordered table-hover" style="width:100%;" id="tablaLL">
            <thead>
...
<style type="text/css">
    ...
    @media (max-width: 375px) {
        ...
        #tablaLL_filter label{
            margin-top: 5px;
            float: left;
            width: 90%;
        }
        #tablaLL_filter label .input-sm{
            width: 90%;
        }
        #tablaLL_filter{
            margin-top: 10px;
...
<script>
    $(document).ready(function() {
       var table =  $('#tablaLL').DataTable( {
        ...
        $('#tablaLL tbody').on( 'click', 'tr', function () {
