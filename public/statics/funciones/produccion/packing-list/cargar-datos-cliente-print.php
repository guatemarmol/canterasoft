...
FROM filasPackingListCliente WHERE codigo='$codigo'";
...
while ($verT = mysqli_fetch_row($resultT)) {
    $datosT = $verT[0] . "||" .
        ...
        $verT[6];
    ?>
<div class="container-fluid" id="datosPC">
    <div class="row" style="margin-top: 2px;">
        <h4 style="background-color: #f4f4f4; width: 100%; padding: 3px; margin-bottom: 1px;">
            Packing-List Cliente
        </h4>
        <table class="display table-bordered table-hover" width="100%" id="tablaPP">
            <thead>
                <tr id='titulo-P'>
            ...
            <?php
$codigo = $_REQUEST['codigo'];
    $sql    = "SELECT * FROM filasPackingListCliente WHERE codigo='$codigo' ORDER BY codigo ASC";
    ...
    while ($ver = mysqli_fetch_row($result)) {
        ...
        ?>
            <tr>
                <td id="fila01" style="font-weight: 550; text-align: center; color: #000" class="col-xs-1 col-sm-1 col-md-1 col-lg-1 espacio"></id>
    ...
    ?>
         ...
         <tfoot>
             <tr>
                ...
                <td id="totalCP" style="color: #000000; font-size: 14px;"><?php echo $verT[0] ?></td>
            </tr>
            </tfoot>
<?php
}
...
<style type="text/css">
    ...
    @media (max-width: 375px) {
        ...
        #tablaPP_filter label{
            margin-top: 5px;
            float: left;
            width: 90%;
        }
        #tablaPP_filter label .input-sm{
            width: 90%;
        }
        #tablaPP_filter{
            margin-top: 10px;
