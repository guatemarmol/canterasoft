...
<div class="container-fluid">
    <div class="row">
        <h3 class="nombre-tabla ocultar">Datos Packing List Local</h3>
        <table class="display nowrap table-bordered table-hover" style="width:100%;" id="tablaPackingListLocal">
            <thead>
                <tr id='titulo' class='table-active'>
                    <td id="M0">Código</td>
                    <td id="M1">Tipo</td>
                    <td id="M2">No. Packing List</td>
                    <td id="M3">APDD</td>
            ...
            <tbody>
            <?php
$sql    = "SELECT * FROM packingLocal ORDER BY codigo DESC LIMIT 5";
...
<style type="text/css">
    ...
    @media (max-width: 375px) {
        ...
        #tablaPackingListLocal_filter label{
            margin-top: 5px;
            float: left;
            width: 90%;
        }
        #tablaPackingListLocal_filter label .input-sm{
            width: 90%;
        }
        #tablaPackingListLocal_filter{
            margin-top: 10px;
        }
    }
</style>
<script>
    $(document).ready(function() {
        $('#tablaPackingListLocal').DataTable( {
            "order": [[ 0, 'desc' ]],
            "scrollY":        "180px",
            "scrollCollapse": true,
            "paging":         false,
        ...
        var table = $('#tablaPackingListLocal').DataTable();
        $('#tablaPackingListLocal tbody').on( 'click', 'tr', function () {
