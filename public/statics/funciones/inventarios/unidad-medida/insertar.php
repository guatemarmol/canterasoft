...
<?php
    ...
    $codigo = $_POST['codigo'];    
    $consulta = "SELECT * FROM unidadMedidaInventarios WHERE codigo='$codigo'";
    ...
    $fila = mysqli_fetch_array($ejecutar);
     ...
     if ($fila > 0){
        ...
        $hora = $_POST['hora'];
         ...
         $actualizar ="UPDATE unidadMedidaInventarios SET nombre='$nombre', fecha='$fecha', hora='$hora' WHERE codigo='$codigo'";
        ...
        $consulta = "SELECT MAX(codigo) codigo FROM unidadMedidaInventarios";
        $ejecutar = mysqli_query($con, $consulta);
        ...
        $agregar ="INSERT INTO unidadMedidaInventarios (codigo, nombre, fecha, hora)
