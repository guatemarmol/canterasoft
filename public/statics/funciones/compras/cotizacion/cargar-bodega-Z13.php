...
<div class="container-fluid" style="width:99%">
    <div class="row">
        <h3 class="nombre-tabla ocultar"> Bodega Zona 13</h3>
        <table class="display nowrap table-bordered table-hover" style="width:100%;" id="tablaBodegaZ13">
            <thead>
            ...
            <tbody>
            <?php
            $sql = "SELECT * FROM ordenPedido WHERE bodega = 8 ORDER BY codigo DESC;";
            $result = mysqli_query($con, $sql);
            $url = '';
            if(isset($_GET['estado'])){
                $url = '../compras/orden-compra.php?area=8&estado=cotizado&codigo=';
            }else{
                $url = '../compras/cotizacion.php?area=8&codigo=';
            }
...
<style type="text/css">
    ...
    @media (max-width: 375px) {
        ...
        #tablaBodegaZ13_filter label{
            margin-top: 5px;
            float: left;
            width: 90%;
        }
        #tablaBodegaZ13_filter label .input-sm{
            width: 90%;
        }
        #tablaBodegaZ13_filter{
            margin-top: 10px;
        }
    }
</style>
<script>
    $(document).ready(function() {
        ...
        var table = $('#tablaBodegaZ13').DataTable();
       
        $('#tablaBodegaZ13 tbody').on( 'click', 'tr', function () {
