...
//////////////////////////////////////////
    ...
    $items1 = $_POST['codigoFinal1'];
    $items2 = $_POST['corriente'];
    ...
    while (true) {
        ...
        $sql = "INSERT INTO cuentasXpagarCorriente (codigo, corriente)
    VALUES $valoresQ";
    ...
    echo '<h4>¡ Se Actualizo con Exito Los Dias al Corriente !</h4>';
}