...
if ($row['codigo'] == '0') {
    echo 'No hay datos que Cargar';
    return false;
} else {
//////////////////////////////////////////
    $fin = "DELETE FROM cuentasXpagarTT";
    mysqli_query($con, $fin);
//////////////////////////////////////////
    $items1 = $_POST['codigoFinalT'];
    ...
    while (true) {
        ...
        $sql = "INSERT INTO cuentasXpagarTT (codigo, nombreAcreedor, descripcion, tipo, saldoVencido)
VALUES $valoresQ";
    ...
    echo '<h4>¡ Se Actualizo con Exito el Saldo Vencido TT !</h4>';
