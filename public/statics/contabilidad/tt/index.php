     ...
     <div class="formulario">
        <form action="cuentasXpagar.php" class="formulariocompleto form" method="post" enctype="multipart/form-data">
            ...
            <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2 espacio">
                <button class="button" type="submit" name="enviarTT" onclick="ShowLoading()">
...
if (isset($_POST["enviarTT"])) {
    ...
    $archivo_guardado = "copia_TT_" . $archivo;

    //echo $archivo . "esta en la ruta temporal: " . $archivo_copiado;

    if (copy($archivo_copiado, $archivo_guardado)) {

        echo "<h4 class='avisoTT'>Se copio Cuentas por Pagar TT a nuestra carpeta de Trabajo.</h4><br/>";
    } else {
        echo "<h4 class='avisoTT'>Hubo un error, No se Copio Cuentas por Pagar TT.</h4> <br/>";
    }
        ...
        while ($datos = fgetcsv($fp, 2000, ";")) {
            ...
            if ($rows > 0) {
                ...
                if ($resultado) {
                    ...
                    echo "<h4 class='avisoTT'>No se inserto, Verifica.</h4> <br/>";
                }
            }
        }

    } else {
        echo "<h4 class='aviso1TT'>No existe o no se a Seleccionado el archivo que se intenta Subir.";
    }
}
?>
<style type="text/css">
