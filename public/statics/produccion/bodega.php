...
<head>
    ...
    <title>Bodega | CanteraSoft</title>
    ...
    <div class="container-fluid">
        ...
        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 espacio">
            <form name="form" class="form" id="form" method="POST" action="">
                <?php include_once '../funciones/produccion/bodega/seleccionar.php'?>
                <?php include_once 'bodega.html'?>
            </form>
        </div>
        <div class="col-xs-0 col-sm-0 col-md-1 col-lg-1 espacio">
        </div>
        ...
        <script type="text/javascript" src="../js/produccion/bodega.js"></script>
