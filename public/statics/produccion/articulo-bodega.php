...
<head>
    ...
    <title>Articulo Bodega | CanteraSoft</title>
...
<body>
        ...
        <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10" style="padding-right: 1px; padding-left: 1px;">
                    ...
                    <form name="form" class="form" id="form" method="POST" action="">
                        ...
                        <?php include_once '../funciones/produccion/articulo/seleccionar.php'?>


                        <?php include_once 'articulo-bodega.html'?>
    ...
    <span class="ir-arriba icon-eject"></span>
                    ...
                    <script type="text/javascript" src="../js/produccion/articulo-bodega.js"></script>
