...
<head>
    ...
    <title>Línea Transaccion | CanteraSoft</title>
...
<body>
        ...
        <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10" style="padding-right: 1px; padding-left: 1px;">
                    ...
                    <form name="form" class="form" id="form" method="POST" action="">    
                        ...
                        <?php include_once '../funciones/logistica/linea-transaccion/seleccionar.php' ?>
                        
               <!-------------------------------------------------------HTML------------------------------------------------------------>
               <!-------------------------------------------------------------------------------------------------------------------------->
                        <?php include_once 'linea-transaccion.html' ?>
    ...
    <span class="ir-arriba icon-eject"></span>
                <!--------------------------------------------------JABASCRIPT---------------------------------------------------------->
                <!-------------------------------------------------------------------------------------------------------------------------->
                    <script type="text/javascript" src="../js/logistica/linea-transaccion.js"></script>
