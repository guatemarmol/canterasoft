...
<body>
        ...
        <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 espacio">
                    ...
                    <form name="form" class="form" id="form" method="POST" action="">
                        ...
                        <?php include_once '../funciones/inventarios/suministros/seleccionar.php'?>

               <!-------------------------------------------------------HTML------------------------------------------------------------>
               <!-------------------------------------------------------------------------------------------------------------------------->
                        <?php include_once 'suministros.html'?>
    ...
    <span class="ir-arriba icon-eject"></span>
                <!--------------------------------------------------JABASCRIPT---------------------------------------------------------->
                <!-------------------------------------------------------------------------------------------------------------------------->
                    <script type="text/javascript" src="../js/inventarios/suministros.js"></script>
